...
Hastily, I added even more columns to the dataset for easier access. I also added a z-score normalized value and a min/max normalized value for many of the variables - to make them easier to compare. 
